...
4.  **Command-Line Interface (CLI):** Ubuntu Server operates through a Command-Line Interface (CLI), allowing administrators to manage the system remotely or through SSH (Secure Shell). The absence of a graphical interface helps reduce resource usage and improve security.
...
6.  **Virtualization Support:** Ubuntu Server supports virtualization technologies such as KVM (Kernel-based Virtual Machine) and Docker containers. This allows users to create and manage virtual machines and containers easily and efficiently.
...
Ubuntu Server has become a popular choice for building and managing server infrastructure due to its stability, security, and support for modern technologies such as cloud computing and virtualization. It provides powerful tools for operating servers reliably and efficiently.
...
The default network adapter in VirtualBox is isolated from the outside world. Adding a second, host-only adapter lets you reach the Ubuntu Server VM from your host machine.
...
## Exercise
Try the following Ubuntu commands, explain their functions, and provide screenshots of your results. Complete a total of 15 commands.
