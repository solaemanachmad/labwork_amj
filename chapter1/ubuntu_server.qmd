...
Ubuntu Server has become a popular choice for building and managing server infrastructure due to its stability, security, and support for modern technologies such as cloud computing and virtualization. It provides powerful tools for operating servers reliably and efficiently [@phoenixnap_linux_server]. The hands-on steps for installing and configuring it are covered in @sec-steps-ubuntu.

## Ubuntu Server Practicum Steps {#sec-steps-ubuntu}
...
2.  **Power the VM back on** and edit the Netplan configuration [@netplan_docs].
...
: Essential Linux Commands {#tbl-linuxcommand tbl-colwidths="[5,20,5,20,5,20,5,20]"}